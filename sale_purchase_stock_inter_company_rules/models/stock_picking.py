...
class StockPicking(models.Model):
    ...
    def _find_corresponding_move(self, move_orig, candidate_pickings):
        ...
        for receipt_move in candidate_pickings.move_ids:
            ...
            converted_sale_price = move_orig.sale_line_id.product_uom._compute_price(
                move_orig.sale_line_id.price_unit or 0.0, receipt_move.purchase_line_id.product_uom
            )
            if (
